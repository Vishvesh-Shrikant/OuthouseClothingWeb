            ...
            <div className=' w-full bg-bannerBG px-sectionPadding py-10 relative'>
              <div className='flex justify-between items-center w-full'>
                <div className=' flex flex-col justify-evenly items-start w-1/2'>
                  <p className=' font-headings text-primary text-5xl my-2 '> New Arrivals</p>
                  <p className='text-base font-texts'> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti, provident. Saepe consequuntur animi soluta vitae, ab hic! Nemo rem ipsam adipisci laborum ratione quae tempora ex, similique exercitationem minus labore? </p>
                ...
                <div className='flex justify-center items-center '>
                  <img src={trial1} className="h-96 w-full" />
                </div>
              </div>
            </div>
